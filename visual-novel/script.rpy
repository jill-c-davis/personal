...
label cafe_day_3:
    ...
    show ame smile
    with dissolve
    "You walk up to her and apologize for not coming sooner."
    ...
    a "You know..."
    a "I still don't have your number. Care to share?"
    "She's writing her contact details in your phone faster than you can say yes."
    a "It's been a long day, so I'm going to head home now. See you later?"
    p "Yeah, see you later."
    "With your stomach full and your heart in total bliss, you head back to your dorm."
    ...
    a "I'll bring a charcuterie and it will be chill. Just let me know by noon on Friday and...do me a favor?"
    a "Don't come to see me at work until you've decided whether you can make the picnic or not..."
    a "Otherwise... it's all I'll be thinking about!"
    a "Good night ;)"
    "You reply right away:"
    menu: 
        ":blushing emoji:":
            pass
        "Who knew you could be so...cheesy :x":
            a_points += 1 
            pass
    ...
    scene bg dorm
    with fade
    "You lie on the bottom bunk grinning in spite of yourself."
    play music dooe noloop
    how frog teasing
    with dissolve
...
label day_4:
    ...
    scene bg dorm
    with fade
    "You get ready as quickly as you can and head to the library."

library_day_4:

    scene library bg
    with fade
    "Muse isn't in her usual spot, so you sit down at the long table where she usually resides."
    play music startked noloop
    show cincere tired
    with dissolve
    ...
    menu:
        p "Yeah, I saw you in class just yesterday?":
            pass
        p "Of course I do, you're unforgettable.":
                c_points += 1
                pass
    play music notebook_tear noloop
    "Cincere slides you a note - no - a flyer."
    "It's for an event tomorrow afternoon at the Student Union"
    "She's signed it with her phone number and a note - "
    c "Let me know by tonight if you want to come to this event with me."
    "When you put the note away, she's already gone."

    scene bg library
    with fade
    p "What was that all about?"
    p "She wants to go on a date with me tomorrow? Same as Ame huh..."
    ...
    p "Partner?!"
    p "Um, about yesterday..."
    p "What was it that you wanted to ask me?"
    show muse blush
    with dissolve
    m "I, I wanted to know..."
    m "Will you come to my tour at the Student Center tomorrow?"
    play music "startled.mp3"
    p "..."
    m "You don't have to answer now..." 
    ...
    p "H-here!"
    "You pull your cell phone out from your pocket and hand it to Muse."
    play music "typing.mp3"
    "Muse gives your phone back to you and runs off."
    "You look at her contact in your cell and rejoice at the heart she put next to her name."
    p "Would it really be so bad to see Muse tomorrow?"
        "On your way back to your dorm, you realize that three cute girls asked you on a date for the same date and time."
    
    scene bg dorm
    with fade 
    "You can't date all of them, so you decide who you want to see the most:"
    menu: 
        "Cincere":
            $ c_points += 1
            jump final_day
...
label final_day: 
    ...
    "You linger in the mirror a bit longer than usual, but decide that you look just as handsome as ever."
