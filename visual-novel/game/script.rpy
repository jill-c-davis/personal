...
default inventory = {
    ...
    "Cincere" : [
        "Godzilla (1954)" if persistent.godzilla_collected else None, 
        "Dos Monjes (1934)" if persistent.dos_monjes_collected else None, 
...
label final_night: 
    ...
    # check ghost route 
    if inventory["Love Letter"] and inventory["Locket"] and inventory["Class Ring"]:
...
label jump ameRoute_bad_ending_continued:
...
label jump museRoute_bad_ending_continued:
